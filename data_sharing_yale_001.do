...
#delimit ;
import delimited record_id redcap_survey_identifier response_type_timestamp response_type response_type_complete consent_timestamp consent01 consent02 consent_complete
 demographics_timestamp gender age_group country island organization occupation occupation_other occapation_status experience demographics_complete data_sharing_behavio_v_0 
 dh_01 dh_03 dh_02 ds_01a ds_01b ds_01c ds_01d ds_01e ds_01f ds_02 ds_03 ds_04 ds_05 ds_06 ds_07 ds_08 ds_09 ds_10 ds_11 ds_12 ds_13 ds_14 ds_15 ds_16 ds_17 ds_18 ds_19
ds_20 ds_21 ds_22 ds_23 ds_24 ds_25 ds_26 ds_27 ds_28 ds_29 data_sharing_behavio_v_1 data_sharing_prefere_v_2 dahp_know01 dahp_know02 dahp_know03 dahp_know04 dahp_know06 
security1 security2 data_sharing_prefere_v_3 for_university_staff_timestamp fr_01 fr_02 fr_03 fr_04 for_university_staff_complete personal_data_timestamp dp_1 dp_2 dp_3 dp_4 
dp_5 dp_6 dp_7 dp_8 dp_9 dp_10 dp_11 personal_data_complete end_timestamp end_01 end_02___1 end_02___2 end_03 end_complete
using "`datapath'\version01\1-input\YaleTCCDataSurvey202_DATA_NOHDRS_2020-07-30_1134.csv", varnames(nonames);
#delimit cr

label data "Yale-TCC DataSharing Questionnaire: June 2020"
...
#delimit ;
order record_id redcap_survey_identifier response_type_timestamp response_type response_type_complete consent_timestamp 
consent01 consent02 consent_complete demographics_timestamp gender age_group country island organization occupation occupation_other 
occapation_status experience demographics_complete data_sharing_behavio_v_0 dh_01 dh_03 dh_02 ds_01a ds_01b ds_01c ds_01d ds_01e ds_01f ds_02 
ds_03 ds_04 ds_05 ds_06 ds_07 ds_08 ds_09 ds_10 ds_11 ds_12 ds_13 ds_14 ds_15 ds_16 ds_17 ds_18 ds_19 ds_20 ds_21 ds_22 ds_23 ds_24 ds_25 ds_26
ds_27 ds_28 ds_29 data_sharing_behavio_v_1 data_sharing_prefere_v_2 dahp_know01 dahp_know02 dahp_know03 dahp_know04 dahp_know06 security1 security2 
data_sharing_prefere_v_3 for_university_staff_timestamp fr_01 fr_02 fr_03 fr_04 for_university_staff_complete personal_data_timestamp dp_1 dp_2 dp_3 
dp_4 dp_5 dp_6 dp_7 dp_8 dp_9 dp_10 dp_11 personal_data_complete end_timestamp end_01 end_02___1 end_02___2 end_03 end_complete; 
#delimit cr
set more off
describe 

save "`datapath'\version01\2-working\yale_datasharing_001", replace 
